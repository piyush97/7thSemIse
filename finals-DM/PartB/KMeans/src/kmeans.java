...
class kmeans
{
	...
	public static void main(String args[]) throws FileNotFoundException, IOException
	{
		...
		String data = csv.readLine(); ArrayList<record> al = new ArrayList<>(); while(data != null)
		{
		...
		System.out.println(r.attr1 +" "+r.attr2); System.out.println("1st cluster"); for(record r:c2)
		System.out.println(r.attr1 +" "+r.attr2); System.out.println("2nd cluster"); for(record r:c3)
		System.out.println(r.attr1 +" "+r.attr2); System.out.println("centroid"); for(int i=0;i<3;i++)
